...
```
The other configuration file is defined in `MBRL_transport_params.yaml` and it controls the tracking rourte, the environment as well as the interface for pointcloud collection.
