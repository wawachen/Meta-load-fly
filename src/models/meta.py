...
from models.neural_nets import Learner
...
class Meta(nn.Module):
    ...
    Meta Learner
    """
    def __init__(self, args, config, path):
        """
        ...
        if args.load_model:            
            test_model_path = args.load_model_path
...
def main():
    ...
    argparser.add_argument('--log_path', type=str, help='path', default='')

    args = argparser.parse_args()
    maml = Meta(args, config, args.path).to(device)
    print(maml)
