...
if __name__ == '__main__':
    ...
    if not is_predict:
        ...
        log_dir_test = '/home/wawa/catkin_meta/src/MBRL_transport/logs_finetune_Occupancy_predictor_2d_movementall1_{0}'.format(cfg.seed)
        dm.setup('test')
        ...
        # checkpoint_filepath = "/home/wawa/catkin_meta/src/MBRL_transport/logs_finetune_Occupancy_predictor_2d_movementall1_500/lightning_logs/version_0/checkpoints"
